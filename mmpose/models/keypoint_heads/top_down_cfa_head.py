...
class TopDownCFAHead(nn.Module):
    ...
    def __init__(self,
        ...
        self.cfa_out = extra.get('cfa_out', False)

    def forward(self, x):
        """Forward function.
           Return: 
                x: final heatmap for each keypoint
                out: multi-scale upsampling feature map
                [N, 256, 16, 12] [N, 256, 32, 24] [N, 256, 64, 48]
        """
